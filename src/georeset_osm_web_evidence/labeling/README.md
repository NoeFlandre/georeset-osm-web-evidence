...
labeling prompt, parses model responses into `relevant` or `irrelevant`, builds
reviewable prompt rows from sentence candidates, and applies any caller-provided
labeling function to a prompt dataframe.
